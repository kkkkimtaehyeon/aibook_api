...
//        storyService = new StoryServiceImpl(storyRepository, memberRepository, tagRepository);
//    }
//
//    @Transactional
...
//
//        // when
//        Long storyId = storyService.createStory(memberId, new StoryCreateRequestDto(title,baseStory,sentences, true, null));
//
//        // given
