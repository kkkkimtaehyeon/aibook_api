...
@RestController
public class StoryDubbingControllerV3 {
    private static final org.slf4j.Logger log = LoggerFactory.getLogger(StoryDubbingControllerV3.class);
    ...
    public ApiResponse<?> requestVoiceDubbing(@PathVariable("story-id") Long storyId,
        ...
        try {
            storyDubbingService.requestDubbingV3(storyId, voiceId, memberId);
